...
\begin{algorithm}
\caption{Algorithme Total Flow Analysis (TFA)\\ Travail réalisé avec Matthieu AMET}\label{alg:cap}
    \begin{algorithmic}[1]
        \For{$c \in [7 \dots 0]$}
...
\end{tikzpicture}
\end{center}
\caption{Schéma synthétisant le comportement de TFA, issu des travaux de Ludovic THOMAS\cite{thomas_analyse_2022}}
\end{figure}
